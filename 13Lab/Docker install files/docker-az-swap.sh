...
# This file create a swapfile to assist low memory VMs
# installs Docker and adds the user to Docker group 
# This is useful when using the portal NOT Terraform
